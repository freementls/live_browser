...
foreach($O->get_tagged('message') as $message) {
	...
	// would be nice to safely to assume that the last message would be the last acitivity, although with how the chat is asynchronous this isn't necessarily true
}
